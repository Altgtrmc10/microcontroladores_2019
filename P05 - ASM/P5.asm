...
INICIO	BSF 		STATUS, RP0		; PONE EN 1 A RP0 PARA BANCO 3
		...
		CLRF	PORTB			; LIMPIA AL PUERTO B

BUCLE	BTFSC	PORTA, 0		; COMPRUEBA SI EL BIT 0 DEL PUERTO A ESTÁ EN 1
		GOTO	JOHNSN			; VA A LA ETIQUETA "JOHNSON"
...
HALO	RLF 		PORTB, 1
		CALL 	DELAY
		BTFSS 	PORTB, 7		; COMPRUEBA SI EL BIT 7 DEL PUERTO B ESTÁ EN 0
		GOTO 	HALO
		GOTO 	BUCLE
...
REGRESO	RLF 		PORTB, 1
		BCF 		STATUS, 0
		CALL 	DELAY
		BTFSC 	PORTB, 7		; COMPRUEBA SI EL BIT 7 DEL PUERTO B ESTÁ EN 1
		GOTO 	REGRESO
		GOTO 	BUCLE
